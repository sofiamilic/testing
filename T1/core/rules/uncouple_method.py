...
# A veces se tienen metodos definidos en una clase que no usan los atributos de la clase, lo cual podria ser
# una señal para reflexionar de sí ese methods realmente debe definirse en esa clase.
